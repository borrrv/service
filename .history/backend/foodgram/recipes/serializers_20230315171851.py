...
class RecipesSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        for ingredient_data in ingredients_data:
            ...
            amount = ingredient_data.get('amount', None) # получаем значение amount, если оно задано, иначе возвращаем None
            IngredientReciepe.objects.create(ingredients=ingredient, recipe=recipe, amount=amount)
